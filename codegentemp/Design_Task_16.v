// ======================================================================
// Design_Task_16.v generated from TopDesign.cysch
// 12/25/2019 at 23:52
...
module ADC_SAR_SEQ_P4_v2_50_1 (
	...
	cy_clock_v1_0
		#(.id("1faa57a6-e719-4a3c-98e6-b7b0980aaf8c/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
...
// TCPWM_P4_v2_10(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=500, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=false, PWMDeadTimeCycle=0, PWMInterruptMask=0, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=999, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadAutoStart=true, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=0, TCCapturePresent=false, TCCompare=65535, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=2, TCCountingModes=0, TCCountMode=3, TCCountPresent=false, TCInterruptMask=1, TCPeriod=65535, TCPrescaler=0, TCPWMCapturePresent=false, TCPWMConfig=7, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=false, TCRunMode=0, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=false, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=false, TermVisibility_interrupt=true, TermVisibility_line=true, TermVisibility_line_n=true, TermVisibility_ov=true, TermVisibility_reload=false, TermVisibility_start=false, TermVisibility_stop=false, TermVisibility_un=true, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_P4_v2_10, CY_CONFIG_TITLE=Second_PWM, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Second_PWM, CY_INSTANCE_SHORT_NAME=Second_PWM, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Second_PWM, )
...
module top ;
    ...
    ADC_SAR_SEQ_P4_v2_50_1 ADC_SAR_Seq (
        .Vref(Net_70),
        .sdone(Net_71),
        .eoc(Net_97),
        .aclk(1'b0),
	...
	wire [0:0] tmpOE__Pin_AIn_net;
	wire [0:0] tmpFB_0__Pin_AIn_net;
	wire [0:0] tmpIO_0__Pin_AIn_net;
	wire [0:0] tmpINTERRUPT_0__Pin_AIn_net;
	electrical [0:0] tmpSIOVREF__Pin_AIn_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_AIn
		 (.oe(tmpOE__Pin_AIn_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_AIn_net[0:0]}),
		  .analog({Net_152}),
		  .io({tmpIO_0__Pin_AIn_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_AIn_net),
		  .interrupt({tmpINTERRUPT_0__Pin_AIn_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_AIn_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam SPIM.ShiftDir = 1;

	wire [0:0] tmpOE__Pin_SPI_MOSI_net;
	wire [0:0] tmpFB_0__Pin_SPI_MOSI_net;
	wire [0:0] tmpIO_0__Pin_SPI_MOSI_net;
	wire [0:0] tmpINTERRUPT_0__Pin_SPI_MOSI_net;
	electrical [0:0] tmpSIOVREF__Pin_SPI_MOSI_net;

	cy_psoc3_pins_v1_10
		#(.id("194fdb6b-3b8a-4834-978b-57b5574c4c17"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_SPI_MOSI
		 (.oe(tmpOE__Pin_SPI_MOSI_net),
		  .y({Net_75}),
		  .fb({tmpFB_0__Pin_SPI_MOSI_net[0:0]}),
		  .io({tmpIO_0__Pin_SPI_MOSI_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_SPI_MOSI_net),
		  .interrupt({tmpINTERRUPT_0__Pin_SPI_MOSI_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_SPI_MOSI_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_SPI_SCLK_net;
	wire [0:0] tmpFB_0__Pin_SPI_SCLK_net;
	wire [0:0] tmpIO_0__Pin_SPI_SCLK_net;
	wire [0:0] tmpINTERRUPT_0__Pin_SPI_SCLK_net;
	electrical [0:0] tmpSIOVREF__Pin_SPI_SCLK_net;

	cy_psoc3_pins_v1_10
		#(.id("ebf8862c-ea2b-42ba-9452-da2cca6bff16"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_SPI_SCLK
		 (.oe(tmpOE__Pin_SPI_SCLK_net),
		  .y({Net_76}),
		  .fb({tmpFB_0__Pin_SPI_SCLK_net[0:0]}),
		  .io({tmpIO_0__Pin_SPI_SCLK_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_SPI_SCLK_net),
		  .interrupt({tmpINTERRUPT_0__Pin_SPI_SCLK_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_SPI_SCLK_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    // -- DFF Start --
    reg  cydff_1;
    always @(posedge Net_84)
    begin
        cydff_1 <= Net_36;
    end
    assign Net_35 = cydff_1;
    // -- DFF End --


    assign Net_36 = ~Net_35;

	wire [0:0] tmpOE__Pin_SPI_SS_net;
	wire [0:0] tmpFB_0__Pin_SPI_SS_net;
	wire [0:0] tmpIO_0__Pin_SPI_SS_net;
	wire [0:0] tmpINTERRUPT_0__Pin_SPI_SS_net;
	electrical [0:0] tmpSIOVREF__Pin_SPI_SS_net;

	cy_psoc3_pins_v1_10
		#(.id("c7bd5701-6e40-4735-b82d-c779f6662865"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_SPI_SS
		 (.oe(tmpOE__Pin_SPI_SS_net),
		  .y({Net_77}),
		  .fb({tmpFB_0__Pin_SPI_SS_net[0:0]}),
		  .io({tmpIO_0__Pin_SPI_SS_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_SPI_SS_net),
		  .interrupt({tmpINTERRUPT_0__Pin_SPI_SS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_SPI_SS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("4e9d49e0-018e-4edc-bfbd-c1e2279adbd1"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pin_B3_net;
	wire [0:0] tmpFB_0__Pin_B3_net;
	wire [0:0] tmpIO_0__Pin_B3_net;
	wire [0:0] tmpINTERRUPT_0__Pin_B3_net;
	electrical [0:0] tmpSIOVREF__Pin_B3_net;

	cy_psoc3_pins_v1_10
		#(.id("0ade7d4c-a582-4564-9989-cf0de71ea373"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_B3
		 (.oe(tmpOE__Pin_B3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_B3_net[0:0]}),
		  .io({tmpIO_0__Pin_B3_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_B3_net),
		  .interrupt({tmpINTERRUPT_0__Pin_B3_net[0:0]}),
		  .annotation({Net_88}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_B3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("b8382f28-a400-4e25-8e4d-999719a022be"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_clock_v1_0
		#(.id("a5f4bc2e-9483-4771-8e9d-968c9cecd91a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("125000000"),
		  .is_direct(0),
